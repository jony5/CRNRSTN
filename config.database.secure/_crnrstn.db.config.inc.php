...
# IF CENTRALIZED DATABASE CONFIG MGMT IS NOT YOUR THING, YOU CAN PASS ALL 
# DATABASE AUTH CONFIG PARAMETERS TO $oCRNRSTN_ENV->oMYSQLI_CONN_MGR->returnConnection()  WHEN
# CREATING A MYSQLI DATABASE CONNECTION OBJECT. SEE http://crnrstn.evifweb.com/documentation/classes/mysqli_conn_manager/returnconnection/
#
